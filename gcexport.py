...
URL_GC_OWNER_COURSES = f'{GARMIN_BASE_URL}/web-gateway/course/owner/'
...
def parse_arguments(argv):
    ...
    parser.add_argument('-s', '--subdir',
        help='the subdirectory for activity or course files (fit, gpx, tcx, etc.), supported placeholders are {YYYY} and {MM} (default: export directory)')
    ...
    parser.add_argument('-fp', '--fileprefix', action='count', default=0,
        help='set the local time as activity or course file name prefix')
...
def export_data_file(activity_id, activity_details, args, file_time, append_desc, date_time):
    ...
    if args.format == 'gpx':
        ...
        raise ValueError('Unrecognized format. Valid formats: \'gpx\', \'tcx\', \'original\' or \'json\'.')
